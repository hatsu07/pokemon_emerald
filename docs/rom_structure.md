...
|---|---|---|---|---|---|
| `gScriptCmdTable` | `0x1dabac` | `0x384` | `0x81DABAC` | 不明 | 小ブロック |
| `gScriptCmdTableEnd` | `0x1daf30` | `0x4` | `0x81DAF30` | いいえ | 小ブロック |
| `gSpecialVars` | `0x1daf34` | `0x58` | `0x81DAF34` | 不明 | 小ブロック |
| `gSpecials` | `0x1daf8c` | `0x830` | `0x81DAF8C` | 不明 | 中ブロック |
...
| `EventScript_JP_081F0DDB` | `0x1f0ddb` | `0xc96` | `0x81F0DDB` | 不明 | 中ブロック |
| `LittlerootTown_ProfessorBirchsLab_EventScript_ScottAboardSSTidalCall` | `0x1f1a71` | `0xc` | `0x81F1A71` | いいえ | 小ブロック（ヘッダ） |
...
| `gText_Rom_226D61` | `0x226d61` | `0x6950` | `0x8226D61` | 不明 | 大ブロック（26.9KB） |
| `EventScript_JP_0822D6B1` | `0x22d6b1` | `0x67` | `0x822D6B1` | 不明 | 小ブロック |
...
| 項目 | 値 |
|---|---|
| 元のブロック | `LittlerootTown_ProfessorBirchsLab_EventScript_ScottAboardSSTidalCall`（0x1f1a71, 0x1099f） |
| ROMオフセット範囲 | `0x1f1a7d` ~ `0x1f217c` |
| 分割後の前半 | `LittlerootTown_ProfessorBirchsLab_EventScript_ScottAboardSSTidalCall`: `0x1f1a71` 〜 `0x1f1a7d`（`0xc`バイト） |
| テキスト | `data/text/birch_lab.inc`（25件、`0x6ff`バイト） |
| 分割後の後半 | `gText_BirchLab_LittlerootTown_ProfessorBirchsLab_Text_OtherRegionsUpgradeToNational`: `0x1f217c` 〜 `0x202b0b`（`0x20894`バイト） |
...
| ブロック | サイズ | 可能性 |
|---|---|---|
| `EventScript_JP_081DDDF3`（0x1dddf3, `0x4a04`） | 18.5KB | イベントスクリプト・テキスト |
