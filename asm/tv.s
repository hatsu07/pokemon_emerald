...
_080EFCFC: .4byte gUnknown_85645A0
_080EFD00:
	ldr r1, _080EFD14
	lsls r0, r0, #2
	adds r0, r0, r1
...
_080EFD18: .4byte gUnknown_85645A0
_080EFD1C:
	ldr r1, _080EFD30
	lsls r0, r0, #2
	adds r0, r0, r1
...
_080EFD34: .4byte gUnknown_85645A0
_080EFD38:
	ldr r1, _080EFD4C
	lsls r0, r0, #2
	adds r0, r0, r1
...
_080EFD50: .4byte gUnknown_85645A0
...
_080EFD9C: .4byte gUnknown_85645A0
_080EFDA0:
	ldr r1, _080EFDB4
	lsls r0, r2, #2
	adds r0, r0, r1
...
_080EFDB8: .4byte gUnknown_85645A0
_080EFDBC:
	ldr r1, _080EFDD0
	lsls r0, r2, #2
	adds r0, r0, r1
...
_080EFDD4: .4byte gUnknown_85645A0
_080EFDD8:
	ldr r1, _080EFDEC
	lsls r0, r2, #2
	adds r0, r0, r1
...
_080EFDF0: .4byte gUnknown_85645A0
_080EFDF4:
	ldr r1, _080EFE08
	lsls r0, r2, #2
	adds r0, r0, r1
...
_080EFE0C: .4byte gUnknown_85645A0
